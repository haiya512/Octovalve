export const messages = {
  'zh-CN': {
    ...
    chat: {
      ...
      aggressive: {
        enable: '开启激进模式（仅当前会话，命令自动放行）',
        disable: '关闭激进模式',
        enabledToast: '激进模式已开启（仅当前会话）：命令将直接放行',
        disabledToast: '激进模式已关闭',
        switchFailed: '切换激进模式失败：{error}',
      },
  ...
  'en-US': {
    ...
    chat: {
      ...
      aggressive: {
        enable: 'Enable aggressive mode (current chat session only)',
        disable: 'Disable aggressive mode',
        enabledToast: 'Aggressive mode enabled for this chat session',
        disabledToast: 'Aggressive mode disabled',
        switchFailed: 'Failed to switch aggressive mode: {error}',
      },
    ...
    target: {
      ...
      detail: {
        command: 'Command',
        intent: 'Intent',
        targetName: 'Target host name',
        targetHost: 'Target IP/host',
